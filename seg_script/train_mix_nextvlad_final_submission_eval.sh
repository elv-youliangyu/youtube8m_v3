...
#pretrain_model=parallel4_mix3_nextvlad_x2_1T1_8g_5l2_5drop_128k_2048_80_logistic_fix_final/model.ckpt-120686  #583262
...
#                    --batch_size=1024 --num_readers=8 --segment_labels=True --top_k=1000
...
python inference.py --output_file ${result_folder}/${train_dir}_val_single.csv \
                    ...
                    --batch_size=1024 --num_readers=8 --segment_labels=True --top_k=60
